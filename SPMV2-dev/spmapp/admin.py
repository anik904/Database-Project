...
class University_TAdmin(admin.ModelAdmin):
    list_display = [field.name for field in University_T._meta.fields if field.name != "id"]
...
class Account_TAdmin(admin.ModelAdmin):
    list_display = [field.name for field in Account_T._meta.fields if field.name != "id"]


admin.site.register(Account_T, Account_TAdmin)
...
class Instructor_TAdmin(admin.ModelAdmin):
    list_display = [field.name for field in Instructor_T._meta.fields if field.name != "id"]
...
class CO_Course_TAdmin(admin.ModelAdmin):
    list_display = [field.name for field in CO_Course_T._meta.fields if field.name != "id"]
