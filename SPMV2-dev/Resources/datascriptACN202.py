...
course = Course_T(courseID='ACN202', courseName="Managerial Accounting", numOfCredits=3, programID=2,
...
faculties.append(Instructor_T.objects.get(pk=4202)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4203)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("ACN202.xlsx", sheet_name="Marks") # change
