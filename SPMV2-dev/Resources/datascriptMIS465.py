...
course = Course_T(courseID='MIS465', courseName="E-commerce", numOfCredits=3, programID=4,
...
colist.append(CO_T(coNum="CO2", course=course, plo=plolist[1])) #chnage
colist.append(CO_T(coNum="CO3", course=course, plo=plolist[2])) #chnage
colist.append(CO_T(coNum="CO4", course=course, plo=plolist[3])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("MIS465.xlsx", sheet_name="Marks") # change
