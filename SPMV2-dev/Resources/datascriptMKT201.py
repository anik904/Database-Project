...
course = Course_T(courseID='MKT201', courseName="Principles of Marketing", numOfCredits=3, programID=2,
...
faculties = []
faculties.append(Instructor_T.objects.get(pk=4207)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4208)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4209)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("MKT201.xlsx", sheet_name="Marks") # change
