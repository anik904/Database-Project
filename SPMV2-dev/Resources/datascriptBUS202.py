...
course = Course_T(courseID='BUS202', courseName="Business Mathematics", numOfCredits=3, programID=2,
...
faculties = []
faculties.append(Instructor_T.objects.get(pk=4204)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4205)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4206)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("BUS202.xlsx", sheet_name="Marks") # change
