...
course = Course_T(courseID='BUS201', courseName="Introduction to Business", numOfCredits=3, programID=2,courseType="Core")
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("BUS201.xlsx", sheet_name="Marks") # change
