...
course = Course_T(courseID='CSE210', courseName="Electronics I", numOfCredits=4, programID=1,
...
colist.append(CO_T(coNum="CO1", course=course, plo=plolist[10])) #chnage
colist.append(CO_T(coNum="CO2", course=course, plo=plolist[0])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE210.xlsx", sheet_name="Marks") # change
