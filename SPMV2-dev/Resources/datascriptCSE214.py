...
course = Course_T(courseID='CSE214', courseName="Computer Organization and Architecture", numOfCredits=3, programID=1,
...
colist.append(CO_T(coNum="CO3", course=course, plo=plolist[4])) #chnage
colist.append(CO_T(coNum="CO4", course=course, plo=plolist[9])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE214.xlsx", sheet_name="Marks") # change
