...
course = Course_T(courseID='EEE313', courseName="Electromagnetic Fields and Waves", numOfCredits=3, programID=3,
...
faculties = []
faculties.append(Instructor_T.objects.get(pk=4307)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4308)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4309)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("EEE313.xlsx", sheet_name="Marks") # change
