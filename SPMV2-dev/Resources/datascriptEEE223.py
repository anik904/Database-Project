...
course = Course_T(courseID='EEE223', courseName="Mechanical Engineering Fundamentals", numOfCredits=4, programID=3,
...
faculties = []
faculties.append(Instructor_T.objects.get(pk=4304)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4305)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4306)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("EEE223.xlsx", sheet_name="Marks") # change
