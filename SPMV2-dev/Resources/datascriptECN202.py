...
course = Course_T(courseID='ECN202', courseName="Principles of Macroeconomics", numOfCredits=3, programID=2,
...
faculties = []
faculties.append(Instructor_T.objects.get(pk=4104)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4105)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4106)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("ECN202.xlsx", sheet_name="Marks") # change
