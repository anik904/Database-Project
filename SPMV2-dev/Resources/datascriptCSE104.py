...
course = Course_T(courseID='CSE104', courseName="Electrical Circuit Analysis", numOfCredits=4, programID=1,
...
faculties = []
faculties.append(Instructor_T.objects.get(pk=4107)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4108)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4109)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE104.xlsx", sheet_name="Marks") # change
