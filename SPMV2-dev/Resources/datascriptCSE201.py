...
course = Course_T(courseID='CSE201', courseName="Discrete Mathematics", numOfCredits=3, programID=1,
...
colist.append(CO_T(coNum="CO1", course=course, plo=plolist[5])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE201.xlsx", sheet_name="Marks") # change
