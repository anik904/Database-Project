...
course = Course_T(courseID='GSG103', courseName="GSG103", numOfCredits=3, programID=6,
...
faculties = []
faculties.append(Instructor_T.objects.get(pk=4601)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4602)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4603)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("GSG103.xlsx", sheet_name="Marks") # change
