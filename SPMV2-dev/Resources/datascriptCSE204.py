...
course = Course_T(courseID='CSE204', courseName="Digital Logic Design", numOfCredits=4, programID=1,
...
colist.append(CO_T(coNum="CO1", course=course, plo=plolist[2])) #chnage
colist.append(CO_T(coNum="CO2", course=course, plo=plolist[11])) #chnage
colist.append(CO_T(coNum="CO3", course=course, plo=plolist[7])) #chnage
colist.append(CO_T(coNum="CO4", course=course, plo=plolist[8])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE204.xlsx", sheet_name="Marks") # change
