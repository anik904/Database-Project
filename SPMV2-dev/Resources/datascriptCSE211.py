...
course = Course_T(courseID='CSE211', courseName="Algorithms", numOfCredits=4, programID=1,
...
colist.append(CO_T(coNum="CO1", course=course, plo=plolist[11])) #chnage
colist.append(CO_T(coNum="CO2", course=course, plo=plolist[4])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE211.xlsx", sheet_name="Marks") # change
