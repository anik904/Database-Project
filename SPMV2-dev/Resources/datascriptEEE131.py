...
course = Course_T(courseID='EEE131', courseName="Electrical Circuit I", numOfCredits=4, programID=3,
...
colist.append(CO_T(coNum="CO4", course=course, plo=plolist[1])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("EEE131.xlsx", sheet_name="Marks") # change
