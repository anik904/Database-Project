...
course = Course_T(courseID='MIS441', courseName="Accounting Information Systems", numOfCredits=3, programID=4,
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("MIS441.xlsx", sheet_name="Marks") # change
