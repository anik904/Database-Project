...
course = Course_T(courseID='MIS455', courseName="Accounting Information Systems", numOfCredits=3, programID=4,
...
faculties = []
faculties.append(Instructor_T.objects.get(pk=4404)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4405)) # change: faculty
faculties.append(Instructor_T.objects.get(pk=4406)) # change: faculty
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("MIS445.xlsx", sheet_name="Marks") # change
