...
course = Course_T(courseID='CSE309', courseName="Web Applications and Internet", numOfCredits=3, programID=1,
...
colist.append(CO_T(coNum="CO3", course=course, plo=plolist[5])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE309.xlsx", sheet_name="Marks") # change
