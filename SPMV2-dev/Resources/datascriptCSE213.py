...
course = Course_T(courseID='CSE213', courseName="Object-Oriented Programming", numOfCredits=4, programID=1,
...
colist.append(CO_T(coNum="CO1", course=course, plo=plolist[7])) #chnage
colist.append(CO_T(coNum="CO2", course=course, plo=plolist[8])) #chnage
...
def updatedatabase(d, sem, y):
    ...
    df = pd.read_excel("CSE213.xlsx", sheet_name="Marks") # change
